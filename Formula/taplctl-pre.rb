class TaplctlPre < Formula
  ...
  url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta1/taplctl-2.0.0b1-py3-none-any.whl"
  version "2.0.0b1"
  sha256 "bfbdbd25c5041659c4bf2ac245edb37512d7a67ec3012c95176cfe368b3730d2"
  license "MIT"
  ...
  on_macos do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta1/taplctl-mcp-runtime-2.0.0-beta1-macos-arm64.tar.gz"
        sha256 "c220598eb790defbb299a40d5bab0c8de4c1b72ae33ead6536fb69f721690e1a"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta1/taplctl-mcp-runtime-2.0.0-beta1-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta1/taplctl-mcp-runtime-2.0.0-beta1-linux-arm64.tar.gz"
        sha256 "f92434219dd5adec58bb768d888080cfb255de81b085af05ee0311eae935785a"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta1/taplctl-mcp-runtime-2.0.0-beta1-linux-x86_64.tar.gz"
