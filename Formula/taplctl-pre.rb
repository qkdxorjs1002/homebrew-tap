class TaplctlPre < Formula
  ...
  url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta10/taplctl-2.0.0b10-py3-none-any.whl"
  version "2.0.0b10"
  sha256 "1ce9d07850c621c093390d53e3e1fb20eba34d1d798279dd93513761fae82dbd"
  license "MIT"
  ...
  on_macos do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta10/taplctl-mcp-runtime-2.0.0-beta10-macos-arm64.tar.gz"
        sha256 "c816b543a938fa8e36ec528e3f5e61317dd041e667cf6674ae998bc6b15a1742"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta10/taplctl-mcp-runtime-2.0.0-beta10-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta10/taplctl-mcp-runtime-2.0.0-beta10-linux-arm64.tar.gz"
        sha256 "eb23efecbd070739927aa31d20b7779f1a28cf03ab7bad295fd456e54916d971"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta10/taplctl-mcp-runtime-2.0.0-beta10-linux-x86_64.tar.gz"
