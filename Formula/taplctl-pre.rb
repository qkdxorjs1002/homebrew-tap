class TaplctlPre < Formula
  ...
  url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta14/taplctl-2.0.0b14-py3-none-any.whl"
  version "2.0.0b14"
  sha256 "9bcd85b3ef38623964414dffbb5832ca3357ce65ad7b7aca772d33f5fcc52814"
  license "MIT"
  ...
  on_macos do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta14/taplctl-mcp-runtime-2.0.0-beta14-macos-arm64.tar.gz"
        sha256 "c816b543a938fa8e36ec528e3f5e61317dd041e667cf6674ae998bc6b15a1742"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta14/taplctl-mcp-runtime-2.0.0-beta14-macos-x86_64.tar.gz"
        sha256 "f4d48d332f6c6e8d8f53c8261d5e56d5a9a433050cb6c35df9dbea6b4e8c94ca"
      end
    end
  end
  on_linux do
    on_arm do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta14/taplctl-mcp-runtime-2.0.0-beta14-linux-arm64.tar.gz"
        sha256 "eb23efecbd070739927aa31d20b7779f1a28cf03ab7bad295fd456e54916d971"
      end
    end
    on_intel do
      resource "mcp-runtime" do
        url "https://github.com/qkdxorjs1002/tapl/releases/download/2.0.0-beta14/taplctl-mcp-runtime-2.0.0-beta14-linux-x86_64.tar.gz"
        sha256 "4507a62c13a74d59286831596e5f5f366d008cd2669267afceef0c2a90ba55ba"
      end
    end
  end
